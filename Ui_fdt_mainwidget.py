...
"  padding-top: 6px;}"))
        ...
        self.label = QtGui.QLabel(self.gridsGrpBx)
        self.label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label.setObjectName(_fromUtf8("label"))
        self.horizontalLayout_3.addWidget(self.label)
        self.gridsRemoveAllBtn = QtGui.QToolButton(self.gridsGrpBx)
        self.gridsRemoveAllBtn.setMaximumSize(QtCore.QSize(16777215, 24))
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/remove-all.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.gridsRemoveAllBtn.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/grid.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.gridsTab, icon5, _fromUtf8(""))
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/arrange-raise.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.arrangeRaiseBtn.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/arrange-lower.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.arrangeLowerBtn.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/arrange-to-top.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.arrangeToTopBtn.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/arrange-to-bottom.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.arrangeToBottomBtn.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/bone.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.featuresTab, icon10, _fromUtf8(""))
    ...
    def retranslateUi(self, MainWidget):
        ...
        self.label.setText(_translate("MainWidget", "Delete all grids for origin", None))
        self.gridsRemoveAllBtn.setToolTip(_translate("MainWidget", "Remove grid", None))
