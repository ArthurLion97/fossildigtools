...
"  padding-top: 6px;}"))
        ...
        sizePolicy.setHeightForWidth(self.directPinList.sizePolicy().hasHeightForWidth())
        self.directPinList.setSizePolicy(sizePolicy)
        self.directPinList.setMinimumSize(QtCore.QSize(0, 100))
        self.directPinList.setMaximumSize(QtCore.QSize(16777215, 100))
        ...
        self.gridLayout_6.addWidget(self.directPinList, 1, 1, 2, 1)
        ...
        self.gridLayout_6.addWidget(self.directPinLabel, 0, 1, 1, 2)
        self.offsetPinLabel = QtGui.QLabel(self.directPinFrame)
        self.offsetPinLabel.setObjectName(_fromUtf8("offsetPinLabel"))
        self.gridLayout_6.addWidget(self.offsetPinLabel, 3, 1, 1, 1)
        self.offsetPinList = QtGui.QListWidget(self.directPinFrame)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.offsetPinList.sizePolicy().hasHeightForWidth())
        self.offsetPinList.setSizePolicy(sizePolicy)
        self.offsetPinList.setMinimumSize(QtCore.QSize(0, 100))
        self.offsetPinList.setMaximumSize(QtCore.QSize(16777215, 100))
        self.offsetPinList.setEditTriggers(QtGui.QAbstractItemView.NoEditTriggers)
        self.offsetPinList.setObjectName(_fromUtf8("offsetPinList"))
        self.gridLayout_6.addWidget(self.offsetPinList, 4, 1, 2, 1)
        self.offsetPinIconLabel = QtGui.QLabel(self.directPinFrame)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.offsetPinIconLabel.sizePolicy().hasHeightForWidth())
        self.offsetPinIconLabel.setSizePolicy(sizePolicy)
        self.offsetPinIconLabel.setText(_fromUtf8(""))
        self.offsetPinIconLabel.setPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/offset.svg")))
        self.offsetPinIconLabel.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.offsetPinIconLabel.setObjectName(_fromUtf8("offsetPinIconLabel"))
        self.gridLayout_6.addWidget(self.offsetPinIconLabel, 3, 0, 1, 1)
        self.verticalLayout_9 = QtGui.QVBoxLayout()
        self.verticalLayout_9.setSpacing(6)
        self.verticalLayout_9.setObjectName(_fromUtf8("verticalLayout_9"))
        self.offsetPinAddBtn = QtGui.QToolButton(self.directPinFrame)
        self.offsetPinAddBtn.setMaximumSize(QtCore.QSize(16777215, 24))
        self.offsetPinAddBtn.setIcon(icon3)
        ...
        self.offsetPinGoToBtn.setObjectName(_fromUtf8("offsetPinGoToBtn"))
        ...
        self.gridLayout_6.addLayout(self.verticalLayout_8, 1, 2, 2, 1)
        ...
        self.gridLayout_4.addWidget(self.gridFrame, 2, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.gridsEditFrame, 1, 1, 1, 1)
        self.gridsCmbBx = QtGui.QComboBox(self.gridsGrpBx)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.MinimumExpanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.gridsCmbBx.sizePolicy().hasHeightForWidth())
        self.gridsCmbBx.setSizePolicy(sizePolicy)
        ...
        self.gridsGoToCornerFrame = QtGui.QFrame(self.gridsGrpBx)
        self.gridsGoToCornerFrame.setFrameShape(QtGui.QFrame.NoFrame)
        self.gridsGoToCornerFrame.setFrameShadow(QtGui.QFrame.Raised)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/goto-grid-ur.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.gridsGoToUrBtn.setIcon(icon4)
        self.gridsGoToUrBtn.setIconSize(QtCore.QSize(20, 20))
        self.gridsGoToUrBtn.setObjectName(_fromUtf8("gridsGoToUrBtn"))
        self.gridLayout_7.addWidget(self.gridsGoToUrBtn, 0, 1, 1, 1)
        self.gridsGoToUlBtn = QtGui.QToolButton(self.gridsGoToCornerFrame)
        self.gridsGoToUlBtn.setMaximumSize(QtCore.QSize(16777215, 24))
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/goto-grid-ul.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.gridsGoToUlBtn.setIcon(icon5)
        self.gridsGoToUlBtn.setIconSize(QtCore.QSize(20, 20))
        self.gridsGoToUlBtn.setObjectName(_fromUtf8("gridsGoToUlBtn"))
        self.gridLayout_7.addWidget(self.gridsGoToUlBtn, 0, 0, 1, 1)
        self.gridsGoToLlBtn = QtGui.QToolButton(self.gridsGoToCornerFrame)
        self.gridsGoToLlBtn.setMaximumSize(QtCore.QSize(16777215, 24))
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/goto-grid-ll.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.gridsGoToLlBtn.setIcon(icon6)
        self.gridsGoToLlBtn.setIconSize(QtCore.QSize(20, 20))
        self.gridsGoToLlBtn.setObjectName(_fromUtf8("gridsGoToLlBtn"))
        self.gridLayout_7.addWidget(self.gridsGoToLlBtn, 1, 0, 1, 1)
        self.gridsGoToLrBtn = QtGui.QToolButton(self.gridsGoToCornerFrame)
        self.gridsGoToLrBtn.setMaximumSize(QtCore.QSize(16777215, 24))
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/goto-grid-lr.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.gridsGoToLrBtn.setIcon(icon7)
        self.gridsGoToLrBtn.setIconSize(QtCore.QSize(20, 20))
        self.gridsGoToLrBtn.setObjectName(_fromUtf8("gridsGoToLrBtn"))
        self.gridLayout_7.addWidget(self.gridsGoToLrBtn, 1, 1, 1, 1)
        self.gridLayout_5.addWidget(self.gridsGoToCornerFrame, 0, 2, 2, 1)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/zoom-grids.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.gridsZoomToAllBtn.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/remove-all.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.gridsRemoveAllBtn.setIcon(icon9)
        ...
        self.gridLayout_4.addWidget(self.gridsAllFrame, 3, 0, 1, 1)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/pins-grids.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.gridsTab, icon10, _fromUtf8(""))
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/arrange-raise.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.arrangeRaiseBtn.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/arrange-lower.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.arrangeLowerBtn.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/arrange-to-top.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.arrangeToTopBtn.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/arrange-to-bottom.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.arrangeToBottomBtn.setIcon(icon14)
        ...
        spacerItem5 = QtGui.QSpacerItem(20, 445, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.verticalLayout_5.addItem(spacerItem5)
        self.scrollArea_2.setWidget(self.scrollAreaWidgetContents_2)
        self.verticalLayout_2.addWidget(self.scrollArea_2)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/fossildigtools/icons/bone.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.featuresTab, icon15, _fromUtf8(""))
    ...
    def retranslateUi(self, MainWidget):
        ...
        self.offsetPinLabel.setText(_translate("MainWidget", "Offset pins", None))
        self.offsetPinList.setSortingEnabled(True)
        self.offsetPinAddBtn.setToolTip(_translate("MainWidget", "Add directional pin", None))
        self.offsetPinAddBtn.setText(_translate("MainWidget", "...", None))
        self.offsetPinRemoveBtn.setToolTip(_translate("MainWidget", "Remove directional pin", None))
        self.offsetPinRemoveBtn.setText(_translate("MainWidget", "...", None))
        self.offsetPinGoToBtn.setToolTip(_translate("MainWidget", "Go to directional pin", None))
        self.offsetPinGoToBtn.setText(_translate("MainWidget", "...", None))
        ...
        self.gridsGoToUrBtn.setToolTip(_translate("MainWidget", "Remove grid", None))
        self.gridsGoToUrBtn.setText(_translate("MainWidget", "-", None))
        self.gridsGoToUlBtn.setToolTip(_translate("MainWidget", "Remove grid", None))
        self.gridsGoToUlBtn.setText(_translate("MainWidget", "-", None))
        self.gridsGoToLlBtn.setToolTip(_translate("MainWidget", "Remove grid", None))
        self.gridsGoToLlBtn.setText(_translate("MainWidget", "-", None))
        self.gridsGoToLrBtn.setToolTip(_translate("MainWidget", "Remove grid", None))
        self.gridsGoToLrBtn.setText(_translate("MainWidget", "-", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.gridsTab), _translate("MainWidget", "Pins/Grids", None))
