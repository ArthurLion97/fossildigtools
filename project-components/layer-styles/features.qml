...
<qgis version="1.9.0-Master" minimumScale="0" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/bufferSize" value="0.01"/>
    ...
    <property key="labeling/fontSize" value="0.05"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="5" min="0" step="1" name="breadth" max="2000"/>
    <edittype labelontop="0" editable="1" unchecked="0" type="7" checked="1" name="counts"/>
    ...
    <edittype labelontop="0" editable="1" type="3" name="left_right">
      <valuepair key="" value=""/>
      <valuepair key="L" value="L"/>
      <valuepair key="R" value="R"/>
    </edittype>
    <edittype labelontop="0" editable="1" type="5" min="0" step="1" name="length" max="2000"/>
    <edittype labelontop="0" editable="1" type="0" name="modified"/>
    <edittype labelontop="0" editable="1" type="12" name="notes"/>
    <edittype labelontop="0" editable="1" type="0" name="number"/>
    <edittype labelontop="0" editable="1" type="0" name="ontogeny"/>
    <edittype labelontop="0" editable="1" type="0" name="origin"/>
    <edittype labelontop="0" editable="1" type="2" name="packaging"/>
    <edittype labelontop="0" editable="1" type="5" min="0" step="1" name="percent" max="100"/>
    <edittype labelontop="0" editable="1" type="0" name="pkuid"/>
    <edittype labelontop="0" editable="1" type="2" name="preservation"/>
    <edittype labelontop="0" editable="1" type="5" min="0" step="1" name="thick" max="2000"/>
    <edittype labelontop="0" editable="1" type="3" name="units">
      <valuepair key="cm" value="cm"/>
      <valuepair key="in" value="in"/>
    </edittype>
